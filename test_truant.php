...
if ($strategy==5){   //Очень чувствительный Вася
  echo "<div class='container'>
<button name='punish' value='Наказать' OnClick='NewDay(buttons[0].value, -2000)'><img width=20  src='https://sc01.alicdn.com/kf/HTB1lLpcOjDpK1RjSZFrq6y78VXaE/bullwhip-bdsm-signal-single-tail-long-whip.jpg'> Наказать</button>
<button name='reward' value='Поощрить' OnClick='NewDay(buttons[1].value, 2000)'><img width=20  src='https://img1.freepng.ru/20180323/dqq/kisspng-gold-medal-olympic-medal-clip-art-golden-cup-5ab5a60f5a8812.1500798115218539673708.jpg'> Поощрить</button>
<button name='nothing' value='Ничего не делать' OnClick='NewDay(buttons[2].value, 0)'><img width=20 src='https://c7.hotpng.com/preview/661/444/1011/american-red-cross-computer-icons-christian-cross-clip-art-big-red-cliparts-thumbnail.jpg'> Ничего не делать</button>
</div>";}
